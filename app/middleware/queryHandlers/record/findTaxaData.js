...
module.exports = async (req, res, next) => {
    ...
    identityNames.forEach((identityName) => {
        ...
        releasedCalls.push(findRecords.count({ identityName, finalDisposition: "Released" }));
        pendingCalls.push(findRecords.count({ identityName, finalDisposition: "Pending under care" }));
    });
