...
module.exports = {
    ...
    adminExistingCases: [queryUser.findAll, queryRecord.count, queryRecord.findAll, renders.adminExistingCases],
    adminExistingCasesSaved: [queryUser.findAll, queryRecord.findAllSaved, renders.adminExistingCasesSaved],
    adminExistingCasesById: [queryRecord.findByCreator, renders.adminExistingCases],
