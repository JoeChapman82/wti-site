(function() {
    ...
    if(document.querySelector('.wti-case-tab') && document.querySelector('.form-error-message')) {
    ...
    document.querySelectorAll('.wti-case-tabs-list-link').forEach(function(item) {
        item.addEventListener('click', switchTabs);
    });

    document.querySelectorAll('.wti-case-tab-success-message-wrapper').forEach(function(item) {
        setTimeout(function() {
    ...
    function switchTabs(e, tab) {
        ...
        document.getElementById(element.dataset.reveal).classList.remove('js-hidden');
    ...
    function sortTable(e) {
        document.querySelectorAll('.wti-table-icon-selected').forEach(function(item) {
        ...
        if(revealer.checked && revealer.dataset.target) {
            ...
            revealer.childNodes.forEach(function(child) {
                if(child.selected && child.dataset.target) {
                    document.getElementById(child.dataset.target).classList.remove('js-hidden');
                }
            });
        }
    });
    ...
    document.querySelectorAll('.wti-table-serch-icon').forEach(function(element) {
